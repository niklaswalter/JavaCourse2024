package session5.abstractclasses.shapes;
 ...
 * We define it to be abstract, so that the class must be defined to be abstract as well. The non-abstract method draw()
